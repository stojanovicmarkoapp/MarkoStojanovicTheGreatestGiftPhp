...
<html>
    <head>
        ...
        <title>The Greatest Gift &#124; Drama novels</title>
        <meta name="keywords" content="Greatest, Gift, Christmas, Prison, Crime"/>
        <meta name="description" content="As for drama novels, The Greatest Gift is gonna make you an offer you cannot refuse!"/>
    ...
    <body>
        ...
        <div class="width100 displayFlex flexDirectionColumn positionAbsolute alignItemsCenter bottom50 tabletDisplayNone">
            <div class="wrapper textAlignCenter">
                ...
                <h3 class="redColor">Drama novels</h3>
            </div>
        </div>
            ...
            <div class="wrapper margin0Auto displayFlex justifyContentSpaceBetween tabletFlexDirectionColumn tabletAlignItemsCenter">
                ...
                <div class="width75">
                    <div class="displayFlex flexDirectionColumn laptopAlignItemsCenter">
                        ...
                        <span class="displayFlex tinyMarginTop">
                            <h4 class="tinyMarginRight redColor">Price range from 0 to <output id="topLine">14.56</output>:</h4>
                            <input type="range" min="0" step="0.01" max="14.56" value="14.56" id="priceRange"/>
                        </span> 
                    </div>
                    <div id="titles"></div>
                </div>
        ...
        <script type="text/javascript">
            setTimeout(() => {
                ...
                cartButtons[i].removeAttribute("disabled");
                   //cartButtons[i].previousElementSibling.previousElementSibling.childNodes[1].textContent=="In stock"?"In stock":"cartButtons[i].setAttribute('disabled','true')";
                   if(cartButtons[i].previousElementSibling.previousElementSibling.childNodes[1].textContent=="Not in stock"){
                    cartButtons[i].setAttribute('disabled','true');
                   }
                   console.log(cartButtons[i].previousElementSibling.previousElementSibling.childNodes[1].textContent);
                   console.log(cartButtons[i]);
              }
            }, 1000);
        </script>
